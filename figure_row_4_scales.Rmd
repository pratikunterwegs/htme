...
fig_scales <-
  ...
  geom_path(
    data = data_smooth[time < time[1] + (3600 * 360)],
    aes(x, y),
    size = 0.05,
    # shape = ".",
    col = "steelblue"
  ...
  scale_x_continuous(breaks = c(5.24, 5.26)) +
  coord_sf(
    xlim = c(bbox["xmin"] - 200, bbox["xmax"] - 2500),
